...
static const int64 nTargetTimespan =  60 * 60; // FooCoin: 1 days
static const int64 nTargetSpacing = 25; // FooCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal FreindsCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x46ad34e9527e7d8472f05e0ecf823158e2832c6312df554951243413a30fcf8e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1393610914; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1393610914;
            block.nNonce   = 2084352;
        }
